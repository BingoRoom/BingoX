...
namespace BingoX.Utility
{
    ...
    public static class EmptyUtility
    {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static bool IsEmpty(this System.Data.DataTable dt)
        {
        ...
        /// <param name="dv"></param>
        /// <returns></returns>
        public static bool IsEmpty(this System.Data.DataView dv)
        {
        ...
        /// <param name="ds"></param>
        /// <returns></returns>
        public static bool IsEmpty(this System.Data.DataSet ds)
        {
