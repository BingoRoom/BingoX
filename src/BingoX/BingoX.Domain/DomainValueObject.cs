...
{
    public class DomainValueObject<TObject> : IEquatable<TObject> where TObject : class
    {
        /// <summary>
        ...
        public static bool operator ==(DomainValueObject<TObject> left, DomainValueObject<TObject> right)
        {
