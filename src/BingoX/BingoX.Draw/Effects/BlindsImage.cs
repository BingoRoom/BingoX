...
namespace BingoX.Draw.Effects
{
    ...
    /// 以百叶效果显示图像
    /// </summary>
    [Description("百叶效果"), DisplayName("百叶效果")]
    public class BlindsImage : ImageBuilder
    {
        ...
        [Description("方向"), DisplayName("方向"), Category("濾鏡選項")]
        ...
        [Description("線條數量"), DisplayName("線條數量"), Category("濾鏡選項")]
        public int BarCount
        {
            get
            {
        ...
        [Description("線條大小"), DisplayName("線條大小"), Category("濾鏡選項")]
        public int BarPixel
        {
            get
            {
        ...
        [Description("線條顏色"), DisplayName("線條顏色"), Category("濾鏡選項")]
