...
namespace BingoX.Draw.Effects
{
    ...
    public class ThumbnailImage : ImageBuilder
    {
        ...
        /// 
        /// </summary>
        [Description("縮放方式"), Category("濾鏡選項")]
        ...
        public override Image ProcessBitmap()
        {
            ...
            var exifinfo = ImageExif.GetExifInfo(Source);
            bitmap.Save(ms, new ImageFormat(exifinfo.RawFormatID));
