...
namespace BingoX.Draw.Effects
{
    ...
    /// 邊框
    /// </summary>
    [Description("邊框"), DisplayName("邊框")]
    public class RaiseFrameImage : ImageBuilder
    {
        /// <summary>
        /// 左邊框色
        /// </summary>
        [Description("左邊框色"), DisplayName("左邊框色"), Category("濾鏡選項")]
        ...
        /// 上邊框色
        /// </summary>
        [Description("上邊框色"), DisplayName("上邊框色"), Category("濾鏡選項")]
        ...
        /// 右邊框色
        /// </summary>
        [Description("右邊框色"), DisplayName("右邊框色"), Category("濾鏡選項")]
        ...
        /// 下邊框色
        /// </summary>
        [Description("下邊框色"), DisplayName("下邊框色"), Category("濾鏡選項")]
        ...
        /// 邊框色透明度
        /// </summary>
        [Description("邊框色透明度"), DisplayName("邊框色透明度"), Category("濾鏡選項")]
        public byte Alpha
        {
            get
            {
        ...
        /// 邊框大小
        /// </summary>
        [Description("邊框大小"), DisplayName("邊框大小"), Category("濾鏡選項")]
        public byte Border
        {
            get
            {
        ...
        public class RaiseFrameOption : ImageOption
        {
            ...
            /// 左邊框色
            /// </summary>
            [Description(""), DisplayName("左邊框色"), Category("濾鏡選項")]
            public Color LeftColor { get; set; }

            /// <summary>
            /// 上邊框色
            /// </summary>
            [Description(""), DisplayName("上邊框色"), Category("濾鏡選項")]
            public Color TopColor { get; set; }

            /// <summary>
            /// 右邊框色
            /// </summary>
            [Description(""), DisplayName("右邊框色"), Category("濾鏡選項")]
            public Color RightColor { get; set; }

            /// <summary>
            /// 下邊框色
            /// </summary>
            [Description(""), DisplayName("下邊框色"), Category("濾鏡選項")]
            public Color BottomColor { get; set; }

            /// <summary>
            /// 邊框色透明度
            /// </summary>
            [Description(""), DisplayName("邊框色透明度"), Category("濾鏡選項")]
            public byte Alpha { get; set; }

            /// <summary>
            /// 邊框大小
            /// </summary>
            [Description(""), DisplayName("邊框大小"), Category("濾鏡選項")]
