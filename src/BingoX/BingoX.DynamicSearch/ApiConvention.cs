...
namespace BingoX.DynamicSearch
{
    ...
    class ApiConvention : IApplicationModelConvention
    {
        ...
        private void AddServiceSelector(ActionModel action)
        {
            ...
            selector.ActionConstraints.Add(new Microsoft.AspNetCore.Mvc.Internal.HttpMethodActionConstraint(new[] { GetHttpMethod(action) }));
        ...
        private void NormalizeSelectorRoutes(ActionModel action)
        {
            foreach (var selector in action.Selectors)
            {
                ...
                if (selector.ActionConstraints.OfType<Microsoft.AspNetCore.Mvc.Internal.HttpMethodActionConstraint>().FirstOrDefault()?.HttpMethods?.FirstOrDefault() == null)
                    selector.ActionConstraints.Add(new Microsoft.AspNetCore.Mvc.Internal.HttpMethodActionConstraint(new[] { GetHttpMethod(action) }));
            }
        }
